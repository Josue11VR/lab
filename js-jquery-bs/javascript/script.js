...
$("#childDescendant").click(function () {
    ...
    var child = $('div p:first-child').first().text();
    mostrarResultados(child, 'rosado');

   

    var descendant = $('#languages li').text();
    
    var union = child+descendant;
    
    mostrarResultados(union, 'rosado');
